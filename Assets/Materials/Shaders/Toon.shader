Shader "NonPhotorealistic/Toon"
{
	Properties
	{
		...
		_ShadowMultiplier("Shadow multiplier", Range(0, 1)) = 0.1
	}
	SubShader
	{
		Pass
		{
			...
			float4 frag (v2f i) : SV_Target
			{
				...
				float4 light = lightIntensity == 1 ? lightIntensity : _ShadowMultiplier * _LightColor0;
